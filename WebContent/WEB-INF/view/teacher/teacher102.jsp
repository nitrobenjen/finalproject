...
<!-- 					<tr>
						...
						<td><button type="button" class="btn btn-default"
								data-toggle="modal" data-target="#ing-list-Modal">명단</button></td>
					</tr> -->
	...
	<!-- 수강생 명단 Modal -->
	<div class="modal fade" id="ing-list-Modal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title">강의스케쥴 > 강의 중 > 수강생 정보</h5>
				</div>
