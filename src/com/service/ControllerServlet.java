...
public class ControllerServlet extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Method m = ServiceClass.class.getMethod(command, HttpServletRequest.class, HttpServletResponse.class);
			...
			*/
			...
			if (command.startsWith("teach")) {
				TeachServiceClass service = new TeachServiceClass();
				Method m = TeachServiceClass.class.getMethod(command, HttpServletRequest.class, HttpServletResponse.class);
				viewPage = (String)m.invoke(service, request, response);
			}
